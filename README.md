...
- [`@zhcsyncer/pi-tool-display-intent`](./packages/pi-tool-display-intent) — compact tool rendering with model-written intent phrases, RPC-visible summaries, an optional per-request aggregate Activity, adaptive diffs, and bounded Bash call previews.

...
- [`@zhcsyncer/pi-consult`](./packages/pi-consult) — second-opinion `consult({ why })` with a watchdog, an optional dual-path panel, and a local behavior log. Unconfigured, it unloads itself.

...
assertReadmeIncludes("`Ctrl+Q` discards the stash", "README should document the discard shortcut");
...
assert.ok(readmeZh.includes("`Ctrl+Q` 丢掉暂存"), "Chinese README should document the discard shortcut");

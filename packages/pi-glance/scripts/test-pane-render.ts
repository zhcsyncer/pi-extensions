...
assertLineContainsAll(contextCategory, ["Progress style", "border"], "context progress style setting should render");
assertLineContainsAll(contextCategory, ["Progress width", "one third"], "context progress width setting should render");
